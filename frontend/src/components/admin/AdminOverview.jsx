  ...
  return (
    <div className="space-y-8 relative">
      ...
      {stats.topCandidates && stats.topCandidates.length > 0 && (
        <motion.div custom={6} initial="hidden" animate="visible" variants={cardVariants} className="bg-slate-900/60 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
